...
function create_pu()
{
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if(window.pu.arsae){
            if(!str_contains(window.location.href.toLowerCase(), [window.pu.arsae.toLowerCase()])){
        ...
        window.pux = dpu.make(target, {
            ...
            afterOpen: function(pop) {
                window.location.href = 'http://pop.dojo.cc/click/4270';
            }
        });
